import{s,e as r,c,g as h,h as u,i as l,n as a,f as d}from"../chunks/scheduler.CXdCB_cC.js";import{S as p,i as f}from"../chunks/index.CUASuJes.js";import"../chunks/entry.DHYWvJo9.js";function y(i){let t,o=`<h1>Terms of consent</h1> <p>You can contact our data protection officer via
    ...
    subject rights.</p> <h3>1. Processing of personal data and purposes of processing</h3> <h5 class="svelte-1hz8q1j">a. Voluntarity</h5>
  ...
  <h5 class="svelte-1hz8q1j">b. Legal basis</h5>
  ...
  <h5 class="svelte-1hz8q1j">c. Purpose, Research objective</h5>
  ...
  <p>Subsequent uses of records and data will be subject to standardized data use
    ...
    be disclosed to third parties or used for for-profit purposes.</p> <h3>4. Your rights</h3>
  ...
  <p>Furthermore, you have the right to require the deletion of or the
    restriction of the use of your personal data as well as the right to object
    to their use.</p> <p>If the use of the data is based on your consent (which is the case for data
    ...
    your consent reaches us.</p> <p>In any of the above cases, please contact Robin Gebert via
    <span class="text-accent">st180554@stud.uni-stuttgart.de</span></p> <p>You have the right to submit a complaint to the regulating body if you are
    ...
    of Information Baden-Württemberg.</p> <h3>5. Data security</h3>
    ...
    developments. 
<p><a class="btn btn-primary mt-5" href="/details">I read &amp; accept the terms and conditions</a></p>`;return{c(){t=r("div"),t.innerHTML=o,this.h()},l(e){t=c(e,"DIV",{class:!0,"data-svelte-h":!0}),h(t)!=="svelte-135tiro"&&(t.innerHTML=o),this.h()},h(){u(t,"class","p-6 max-w-4xl mx-auto bg-base-200 rounded-xl shadow-md space-y-4")},m(e,n){l(e,t,n)},p:a,i:a,o:a,d(e){e&&d(t)}}}function g(i){return[]}class w extends p{constructor(t){super(),f(this,t,g,y,s,{})}}export{w as component};
